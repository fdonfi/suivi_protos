...
INSERT INTO t_roles (groupe, id_role, identifiant, nom_role, prenom_role, desc_role, pass, email, organisme, id_unite, pn, session_appli, date_insert, date_update, id_organisme, remarques) VALUES (false, 1, 'admin', 'Administrateur', 'test', NULL, '21232f297a57a5a743894a0e4a801fc3', '', 'Parc national des Cévennes', 1, true, NULL, NULL, NULL, 99,'utilisateur test à modifier');
-- 
...
INSERT INTO t_menus (id_menu, nom_menu, desc_menu, id_application) VALUES (1000004, 'chiro - Validateurs', 'Liste des validateurs chiro', 100);
-- 
