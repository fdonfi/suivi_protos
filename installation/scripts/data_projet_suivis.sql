...
--
-- Name: base_application_id_seq; Type: SEQUENCE SET; Schema: lexique; Owner: fred
--
...
--
-- Name: lexique_id_seq; Type: SEQUENCE SET; Schema: lexique; Owner: fred
--
...
--
-- Name: observateur_id_seq; Type: SEQUENCE SET; Schema: lexique; Owner: fred
--
...
--
-- Data for Name: t_thesaurus; Type: TABLE DATA; Schema: lexique; Owner: fred
--
...
--
-- Name: t_thesaurus_id_seq; Type: SEQUENCE SET; Schema: lexique; Owner: fred
--

SELECT pg_catalog.setval('t_thesaurus_id_seq', 78, true);


--
-- Name: taxonomie_id_seq; Type: SEQUENCE SET; Schema: lexique; Owner: fred
--
